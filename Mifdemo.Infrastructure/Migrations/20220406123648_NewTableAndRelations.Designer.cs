...
namespace Mifdemo.Infrastructure.Migrations
{
    ...
    [Migration("20220406123648_NewTableAndRelations")]
    partial class NewTableAndRelations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mifdemo.Domain.Models.ClientBranch", b =>
                {
                    b.Property<int>("ClientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Mifdemo.Domain.Models.UserBranch", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("Mifdemo.Domain.Models.VoucherBranch", b =>
                {
            ...
            modelBuilder.Entity("Mifdemo.Domain.Models.VoucherBranch", b =>
                {
                    ...
                    b.HasOne("Mifdemo.Domain.Models.VoucherModel", "Voucher")
                        .WithMany("Branches")
