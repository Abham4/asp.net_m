        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountType = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    GlCode = table.Column<int>(type: "int", nullable: false),
                    AccountUsage = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ...
                    Tag = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ManualEntriesAllowed = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastName = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    PassBookNumber = table.Column<int>(type: "int", nullable: false),
                    Age = table.Column<int>(type: "int", nullable: false),
                    Gender = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Address = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Activation_Date = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    IsStaff = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    NoOfLoans = table.Column<int>(type: "int", nullable: false),
                    LastLoanAmount = table.Column<float>(type: "float", nullable: false),
                    ActiveLoans = table.Column<int>(type: "int", nullable: false),
                    ActiveSavings = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortName = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    OriginalLoan = table.Column<float>(type: "float", nullable: false),
                    LoanBalance = table.Column<float>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Age = table.Column<int>(type: "int", nullable: false),
                    isDepandant = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Identifiers_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchasedProducts_Account_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductPurchasedProducts", x => new { x.ProductId, x.PurchasedProductId });
                    table.ForeignKey(
                        name: "FK_ProductPurchasedProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductPurchasedProducts_PurchasedProducts_PurchasedProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clients_PassBookNumber",
                table: "Clients",
                column: "PassBookNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Identifiers_ClientId",
                table: "Identifiers",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductPurchasedProducts_PurchasedProductId",
                table: "ProductPurchasedProducts",
